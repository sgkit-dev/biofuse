...
OPERATIONS: tuple[Operation, ...] = (
    ...
    # -----------------------------------------------------------------
    Operation(
        "p19_freq", "plink1.9", "scan",
        "--freq (full scan)", (*_BFILE, "--freq"),
    ),
    Operation(
        "p19_missing", "plink1.9", "scan",
        "--missing", (*_BFILE, "--missing"),
    ),
    Operation(
        "p19_hardy", "plink1.9", "scan", "--hardy", (*_BFILE, "--hardy"),
    ),
    ...
    Operation(
        "p2_missing", "plink2", "scan", "--missing", (*_BFILE, "--missing"),
    ),
    Operation(
        "p2_hardy", "plink2", "scan", "--hardy", (*_BFILE, "--hardy"),
    ),
    ...
    Operation(
        "p2_make_bed", "plink2", "output", "--make-bed", (*_BFILE, "--make-bed")
    ),
    Operation(
        "p19_recode_A",
        "plink1.9",
    ...
    # -----------------------------------------------------------------
    Operation(
        "p19_freq_t8", "plink1.9", "scan_t8", "--freq --threads 8",
        (*_BFILE, "--freq", "--threads", "8"),
    ),
    Operation(
        "p19_missing_t8", "plink1.9", "scan_t8", "--missing --threads 8",
        (*_BFILE, "--missing", "--threads", "8"),
    ),
    Operation(
        "p19_hardy_t8", "plink1.9", "scan_t8", "--hardy --threads 8",
        (*_BFILE, "--hardy", "--threads", "8"),
    ),
    Operation(
        "p19_het_t8", "plink1.9", "scan_t8", "--het --threads 8",
        (*_BFILE, "--het", "--threads", "8"),
    ),
    Operation(
        "p2_freq_t8", "plink2", "scan_t8", "--freq --threads 8",
        (*_BFILE, "--freq", "--threads", "8"),
    ),
    Operation(
        "p2_missing_t8", "plink2", "scan_t8", "--missing --threads 8",
        (*_BFILE, "--missing", "--threads", "8"),
    ),
    Operation(
        "p2_hardy_t8", "plink2", "scan_t8", "--hardy --threads 8",
        (*_BFILE, "--hardy", "--threads", "8"),
    ),
    Operation(
        "p2_het_t8", "plink2", "scan_t8", "--het --threads 8",
        (*_BFILE, "--het", "--threads", "8"),
    ),
    Operation(
        "p19_make_bed_t8", "plink1.9", "output_t8", "--make-bed --threads 8",
        (*_BFILE, "--make-bed", "--threads", "8"),
    ),
    Operation(
        "p2_make_bed_t8", "plink2", "output_t8", "--make-bed --threads 8",
        (*_BFILE, "--make-bed", "--threads", "8"),
    ),
    Operation(
        "p19_recode_A_t8", "plink1.9", "output_t8", "--recode A --threads 8",
        (*_BFILE, "--recode", "A", "--threads", "8"),
    ),
    Operation(
        "p2_export_A_t8", "plink2", "output_t8", "--export A --threads 8",
        (*_BFILE, "--export", "A", "--threads", "8"),
    ),
    Operation(
        "p19_indep_pairwise_t8", "plink1.9", "ld_t8",
        "--indep-pairwise 50 5 0.1 --threads 8",
        (*_BFILE, "--indep-pairwise", "50", "5", "0.1", "--threads", "8"),
    ),
    Operation(
        "p2_indep_pairwise_t8", "plink2", "ld_t8",
        "--indep-pairwise 50 5 0.1 --threads 8",
        (*_BFILE, "--indep-pairwise", "50", "5", "0.1", "--threads", "8"),
    ),
    Operation(
        "p19_r2_window_t8", "plink1.9", "ld_t8",
        "--r2 --ld-window-r2 0.2 --threads 8",
        (*_BFILE, "--r2", "--ld-window-r2", "0.2", "--threads", "8"),
        expensive=True,
    ),
    Operation(
        "p19_pca_t8", "plink1.9", "pca_t8", "--pca 10 --threads 8",
        (*_BFILE, "--pca", "10", "--threads", "8"),
        expensive=True,
    ),
    Operation(
        "p2_pca_approx_t8", "plink2", "pca_t8",
        "--pca approx 10 --threads 8",
        (*_BFILE, "--pca", "approx", "10", "--threads", "8"),
    ),
    Operation(
        "p19_grm_bin_t8", "plink1.9", "grm_t8",
        "--make-grm-bin --threads 8",
        (*_BFILE, "--make-grm-bin", "--threads", "8"),
        expensive=True,
    ),
    Operation(
        "p2_make_king_t8", "plink2", "grm_t8", "--make-king --threads 8",
        (*_BFILE, "--make-king", "--threads", "8"),
        expensive=True,
    ),
    Operation(
        "p19_linear_t8", "plink1.9", "gwas_t8",
